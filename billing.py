...
class BillClass:
    def __init__(self, root):
        ...
        #title = Label(self.root, text="RetailOps", image=self.icon_title, compound=LEFT, font=("times new roman", 40, "bold"), bg="#010c48", fg="white", anchor="w", padx=20).place(x=0, y=0, relwidth=1, height=100)
        ...
        btn_generate = Button(billMenuFrame, text="Generate", command=self.generate_bill, cursor="hand2", font=("goudy old style", 15, "bold"), bg="#009688", fg="white")
